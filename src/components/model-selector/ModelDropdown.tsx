...
import type { ModelInfo as BaseModelInfo } from "@/bindings";
...
// Temporary patch until bindings are regenerated
type ModelInfo = BaseModelInfo & { languages?: string[] };
  ...
  return (
    <div className="absolute bottom-full left-0 mb-2 w-64 bg-background border border-mid-gray/20 rounded-lg shadow-lg py-2 z-50">
      ...
      {availableModels.length > 0 && (
        <div>
          <div className="px-3 py-1 text-xs font-medium text-text/80 border-b border-mid-gray/10 flex justify-between">
            <span>{t("modelSelector.availableModels")}</span>
            <span className="opacity-50 font-normal">Languages</span>
          </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  {model.languages && model.languages.length > 0 && (
                    <div className="text-[10px] text-text/50 mt-1 uppercase tracking-wider font-medium">
      ...
      {downloadableModels.length > 0 && (
        <div>
          ...
          <div className="px-3 py-1 text-xs font-medium text-text/80 flex justify-between">
            <span>{isFirstRun ? t("modelSelector.chooseModel") : t("modelSelector.downloadModels")}</span>
            <span className="opacity-50 font-normal">Languages</span>
          </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="mt-1 flex gap-2 items-center text-xs text-text/50">
